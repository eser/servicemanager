(function (global, factory) {
    ...
    (global = global || self, factory(global.servicemanager = {}));
    ...
    ***************************************************************************** */
    ...
    function get(map, dependency) {
        ...
        if (serviceTarget.type === exports.ServiceType.Singleton ||
    ...
    function singleton(target, tags) {
        return {
            target: target,
            type: exports.ServiceType.Singleton,
            tags: tags || [],
        };
    }
    ...
    function factory(target, tags) {
        return {
            target: target,
            type: exports.ServiceType.Factory,
            tags: tags || [],
        };
    }
    ...
    exports.useServiceManager = useServiceManager;
